...
namespace Common.SQLite
{
    ...
    public class SQLiteContext
    {
        ...
        public SQLiteContext(string as_tableName)
        {
        ...
        /// <param name="as_tableName">表名</param>
        public SQLiteContext(SQLiteDbca dbca, string as_tableName)
        {
            this.dbca = dbca;
            this.tableName = as_tableName;
        }
        ...
        /// <param name="as_connStr">连接字符串</param>
        /// <param name="as_tableName">表名</param>
        public SQLiteContext(CommandType type, string as_connStr, string as_tableName)
        {
        ...
        /// </summary>
        /// <param name="as_tableName">表名</param>
        public void SetTable(string as_tableName)
        {
            tableName = as_tableName;
        }
        /// <summary>
        ...
        public void AddCol(string as_Col, object as_Set)
        {
            Col.Add(as_Col);
            Set.Add(as_Set);
        }
        ...
        public int Execute(string as_where, params string[] as_param)
        {
            SqlErr = "";
            if (string.IsNullOrEmpty(tableName))
                throw new ArgumentNullException("tableName is not value");
        ...
        /// <param name="as_where">id=@id</param>
        /// <param name="as_param">参数 如as_param1="@id=123"</param>
        public string GetSql(string as_where, params string[] as_param)
        {
            SqlErr = "";
            if (string.IsNullOrEmpty(tableName))
                throw new ArgumentNullException("tableName is not value");
    ...
    public class SQLiteMysysSet
    {
        ...
        /// 写入itemvalue
        /// </summary>
        public static int SetMySysSet(string as_type, string as_item, string as_value, string as_memo = "")
        {
            CreateSysParamTable();
            SqlErr = "";
            int li_row = 0;
            ...
            SQLiteContext lnv_sql = new SQLiteContext();
            lnv_sql.SetTable("mysysset");
            lnv_sql.AddCol("itemvalue", as_value);
            if (!string.IsNullOrEmpty(as_memo))
            {
                lnv_sql.AddCol("memo", as_memo);
            }
            if (li_row <= 0)
            {
                lnv_sql.AddCol("itemtype", as_type);
                lnv_sql.AddCol("itemname", as_item);
                li_row = lnv_sql.Execute();
            }
            else if (li_row > 0)
            {
                li_row = lnv_sql.Execute("itemtype=@itemtype and itemname=@itemname", "@itemtype=" + as_type, "@itemname=" + as_item);
            }
        ...
        /// 写入itemvalue
        /// </summary>
        public static int SetMySysSet(CommandType type, string dbconn, string as_type, string as_item, string as_value, string as_memo = "")
        {
            ...
            SQLiteContext lnv_sql = new SQLiteContext(type, dbconn, "mysysset");
            lnv_sql.AddCol("itemvalue", as_value);
            if (!string.IsNullOrEmpty(as_memo))
            {
                lnv_sql.AddCol("memo", as_memo);
        ...
        /// 写入memo(当前行必须存在) 
        /// </summary>
        public static int SetMySysSetMemo(string as_type, string as_item, string as_memo)
        {
            CreateSysParamTable();
            SqlErr = "";
            int li_row = 0;
        ...
        /// 写入memo(当前行必须存在) 
        /// </summary>
        public static int SetMySysSetMemo(CommandType type, string dbconn, string as_type, string as_item, string as_memo)
        {
            CreateSysParamTable();
            SqlErr = "";
            int li_row = 0;
        ...
        /// 返回itemvalue
        /// </summary>
        public static string GetMySysSet(string as_type, string as_item)
        {
            CreateSysParamTable();
            SqlErr = "";
            string ls_value = "";
        ...
        /// 返回itemvalue
        /// </summary>
        public static string GetMySysSet(CommandType type, string dbconn, string as_type, string as_item)
        {
            CreateSysParamTable(dbconn);
            SqlErr = "";
            string ls_value = "";
        ...
        /// 返回memo
        /// </summary>
        public static string GetMySysSetMemo(string as_type, string as_item)
        {
            CreateSysParamTable();
            SqlErr = "";
            string ls_value = "";
        ...
        /// 返回memo
        /// </summary>
        public static string GetMySysSetMemo(CommandType type, string dbconn, string as_type, string as_item)
        {
            CreateSysParamTable(dbconn);
            SqlErr = "";
            string ls_value = "";
