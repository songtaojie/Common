...
namespace Hx.Sdk.Common.Helper
{
    ...
    public class PinYinHelper
    {
        ...
        private static String Get(Char ch)
        {
            ...
            byte[] arr = Encoding.GetEncoding("gb2312").GetBytes(ch.ToString());
            //Encoding.Default默认在中文环境里虽是GB2312，但在多变的环境可能是其它
            //var arr = Encoding.Default.GetBytes(ch.ToString()); 
            int chr = (Int16)arr[0] * 256 + (Int16)arr[1] - 65536;
        ...
        public static String GetFullPYLetters(String str)  //质管部->ZhiGuanBu
        {
        ...
        public static string GetShortPYLetters(string strText) //质管部->ZGB
        {
        ...
        /// <returns></returns>
        public static string GetFirstPYLetter(string strText) //质管部->Z
        {
            if (strText == null || strText.Length == 0)
                return strText;
