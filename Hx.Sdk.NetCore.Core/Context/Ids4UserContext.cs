...
namespace Hx.Sdk.NetCore.Core.Context
{
    /// <summary>
    /// 用户上下文操作类
    /// </summary>
    internal class Ids4UserContext : IUserContext
    {
        /// <summary>
        /// HttpContext访问器
        /// </summary>
        ...
        public Ids4UserContext(IHttpContextAccessor contextAccessor)
        {
        ...
        public string UserName
        {
            ...
            { 
                ...
                {
                    name = GetClaimValueByType("name").FirstOrDefault();
                }
                return name;
            }
        }
        ...
        /// 用户的昵称
        /// </summary>
        public string NickName => GetClaimValueByType("nickname").FirstOrDefault();

        /// <summary>
        /// 用户的昵称
        /// </summary>
        public bool IsAdmin => GetClaimValueByType<bool>("issuperadmin");
        /// <summary>
        /// 用户的id
        /// </summary>
