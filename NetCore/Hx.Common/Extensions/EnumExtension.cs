...
namespace Hx.Common.Extensions
{
    ...
    {
        // 枚举显示字典缓存
        private static readonly ConcurrentDictionary<Type, Dictionary<int, string>> EnumDisplayValueDict = new ConcurrentDictionary<Type, Dictionary<int, string>>();
        ...
        private static Dictionary<int, string> GetEnumDictionaryItems(this Type enumType)
        {
            ...
            Dictionary<int, string> enumDic = new Dictionary<int, string>(enumFields.Length);
