...
namespace Hx.Sdk.EventBus
{
    ...
    public sealed class EventBusOptionsBuilder
    {
        ...
        /// 事件订阅者类型集合
        /// </summary>
        private readonly List<Type> _eventSubscribers = new List<Type>();
        ...
        /// 事件重试策略类型集合
        /// </summary>
        private readonly List<Type> _fallbackPolicyTypes = new List<Type>();
        ...
        /// 是否使用Cap
        /// </summary>
        public bool? UseCap { get; set; } = false;
        ...
        /// <summary>
        /// 初始化EventBusOptionsBuilder
        /// </summary>
        /// <returns></returns>
        internal static EventBusOptionsBuilder Init(IConfiguration configuration)
        {
            var builder = new EventBusOptionsBuilder();
            ...
            builder.GCCollect = gCCollect;
            _ = bool.TryParse(configuration["EventBus:UseUtcTimestamp"], out bool useUtcTimestamp);
            builder.UseUtcTimestamp = useUtcTimestamp;
            return builder;
        }
        ...
        internal static Action<CapOptions> InitCapOptions(IConfiguration configuration)
        {
            return (CapOptions options) => 
            {
                ...
                var failedRetryIntervalStr = configuration["EventBus:Cap:FailedRetryCount"];
